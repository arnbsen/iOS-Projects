...
struct SetCard : Equatable {
    ...
    static func compareShapeID(first: SetCard, second: SetCard, third: SetCard) -> Bool {
    ...
    static func compareNumber(first: SetCard, second: SetCard, third: SetCard) -> Bool {
    ...
    static func compareShadingID(first: SetCard, second: SetCard, third: SetCard) -> Bool {
    ...
    static func compareColourID(first: SetCard, second: SetCard, third: SetCard) -> Bool {
