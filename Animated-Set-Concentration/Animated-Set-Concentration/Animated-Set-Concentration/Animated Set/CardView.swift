...
class CardView: UIView {
    ...
    var card : SetCard?
    private var drawingColour = #colorLiteral(red: 0.6078431373, green: 0.6078431373, blue: 0.6078431373, alpha: 1)
    private var controller : SetViewController?
    ...
    init(frame: CGRect, forCard : SetCard) {
