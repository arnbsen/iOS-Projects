...
class ViewController: UIViewController {
    ...
    private let shape = ["▲", "●", "■"]
    private let shadingStroke = [-2.0 ,-2.0 ,3.0]
    private let shadingAlpha = [ 1.0 , 0.25, 0.0]
    private let colorValues  = [(243.0/255.0, 156.0/255.0, 18.0/255.0), (192.0/255.0, 57.0/255.0, 43/255.0), (52/255.0, 152/255.0, 219/255.0)]
